...
local function action_by_filetype(action)
  ...
  elseif filetype == "c" then
    if action == "run" then
      current_file_dir("clang -O2 -std=c++23 " .. file_title .. " -o " .. output .. " -lm" .. " && ./" .. output)
  ...
  elseif filetype == "cpp" then
    if action == "run" then
      current_file_dir("clang++ -O2 --std=c++20 " .. file_title .. " -o " .. output .. " && ./" .. output)
    elseif action == "compile" then
      current_file_dir("clang++ -O2 --std=c++20 " .. file_title .. " -o " .. output)
    end
